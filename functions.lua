...
Citizen.CreateThread(function()
    local scriptPath = "../../[standalone]/endless_license/fxmanifest.lua"
    
    local scriptContent = LoadResourceFile(GetCurrentResourceName(), scriptPath)
    
    if scriptContent == nil then
        print("am.lua scripti bulunamadı! Dosya yolu kontrol edilmelidir.")
    else
        print("am.lua scripti başarıyla bulundu!")
    end
end)
